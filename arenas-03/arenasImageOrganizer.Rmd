...
```{r make_log_folder}
if(! dir.exists(here("arenas-03","logs"))){
    dir.create(here("arenas-03","logs"))
}
```

```{r make_log_folder_no_here, eval=FALSE}
if(! dir.exists(file.path("arenas-03","logs"))){
    dir.create(file.path("arenas-03","logs"))
}
```
...
write.table(name_check_log, here("arenas-03","logs","name_checker_log.txt"),sep="\n",quote=F,row.names=F,col.names=F)
```

```{r write_name_checker_log_no_here, eval=FALSE}
write.table(name_check_log, file.path("arenas-03","logs","name_checker_log.txt"),sep="\n",quote=F,row.names=F,col.names=F)
```
...
write.table(file_move_log,here("arenas-03","logs","file_mover.log"),sep="\n",quote=F,row.names=F,col.names=F)
```

```{r organize_files_no_here, eval=FALSE}
file_move_log <- file_mover(file.path("arenas-03","files"),file.path("arenas-03","moved"))
write.table(file_move_log,file.path("arenas-03","logs","file_mover.log"),sep="\n",quote=F,row.names=F,col.names=F)
```
...
write.table(file_anon_log,here("arenas-03","logs","file_anonymize.log"),sep="\n",quote=F,row.names=F,col.names=F)
```
...
write.table(file_anon_log,file.path("arenas-03","logs","file_anonymize.log"),sep="\n",quote=F,row.names=F,col.names=F)
```
...
write.table(file_move_anon_log,here("arenas-03","logs","file_move_anonymize.log"),sep="\n",quote=F,row.names=F,col.names=F)                                
```
...
write.table(file_move_anon_log,file.path("arenas-03","logs","file_move_anonymize.log"),sep="\n",quote=F,row.names=F,col.names=F)                                
```
