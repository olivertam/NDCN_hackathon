...
The code that selects those particular file types is on [line 106 of the `name_checker.R` script](https://github.com/olivertam/NDCN_hackathon/blob/master/arenas-02/code/name_checker.R#L106)
...
code on [line
130](https://github.com/olivertam/NDCN_hackathon/blob/master/arenas-02/code/name_checker.R#L130)
...
smaller chunks (using the `+` as the separator) (see [line 213](https://github.com/olivertam/NDCN_hackathon/blob/master/arenas-02/code/name_checker.R#L213)
