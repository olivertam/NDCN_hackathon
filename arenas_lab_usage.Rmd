...
- create `hackathon_2020-05-29` folder in GH repo
...
source(here("rename_files_20200529/scripts", "batch_rename_files.r"))
...
`rename_files`. It requires these inputs in quotes:

- `microscope`, e.g. "BF"
- `antibody`, e.g. "Thrb488dkDAPI"
- `picture_date`, e.g. "20200522" -- recommend YYYYMMDD not YYMMDD. (even better: YYYY-MM-DD)
- `lens_magnification`, e.g. "20x2_0" -- recommend not using "." because can be confused with fileextension
...
setwd(here("rename_files_20200529/test_files"))
