...
program will not do anything else, as we want the user
...
```{r verbose}
results  <- check_file_names(here("hackathon-arenas-02","files_test","Good_file"),verbose=TRUE)
```

```{r verbose_no_here}
results  <- check_file_names(file.path("hackathon-arenas-02","files_test","Good_file"),verbose=TRUE)
```
...
results <- check_file_names(file.path("hackathon-arenas-02","files_test","Good_file"))
```
