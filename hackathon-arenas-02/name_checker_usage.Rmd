...
## This gives you a list of parameters that the program would take
...
```{r oliver_test}
results <- check_file_names(file.path("hackathon-arenas-02",'files_oliver'))
```
...
For example:
`NES-SAI2d15-OT_200514-01_Vehicle-1_DAPI+go`**PITX3**`-dk488+rb`**ALDH1**`-dk555+mo`**TH**`-dk647**_200520_CF_10X-z2-3.tif`
